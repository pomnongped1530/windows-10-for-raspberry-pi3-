...
set "BuildInfo=17134.1"
set "lang_def=en-us"
set "destDir=uup/!BuildInfo!/!lang_def!/arm64"
set "updateId=561e1a0f-1534-4118-ab09-6cda7b17cc5e"
mkdir %rand%

%aria2% -x16 -s16 -d"%rand%" -o"aria2_script.txt" "https://uup.rg-adguard.net/api/GetFiles?id=!updateId!&lang=!lang_def!&edition=Core&txt=yes"
...
color 0a
call bin\convert-UUP.cmd %cd%\uup\!BuildInfo!\!lang_def!\arm64 %update_en%
goto EOF
